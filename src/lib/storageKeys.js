export const INCOME_STATE_KEY = "finance_tools_income_v1";
...
export const EXPENSES_STATE_KEY = "finance_tools_expenses_v1";
export const PROJECTION_STATE_KEY = "finance_tools_projection_v1";
