...
export function computeRsuGrossForYear(rsus, yearIndex, stockGrowthRate = 0, refresherGrowthRate = 0) {
...
export function computeRsuGrossForItems(rsuItems = [], yearIndex, stockGrowthRate = 0, refresherGrowthRate = 0) {
