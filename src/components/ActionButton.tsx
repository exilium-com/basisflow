...
export function ActionButton(props: ActionButtonProps) {
  ...
  const buttonClassName = clsx(
    "inline-flex h-10 items-center justify-center gap-2 border border-(--line) bg-(--white-soft) px-4 text-sm font-bold text-(--ink) transition hover:-translate-y-px hover:bg-(--white) focus-visible:-translate-y-px focus-visible:bg-(--white) focus-visible:outline-none",
    className,
  );
