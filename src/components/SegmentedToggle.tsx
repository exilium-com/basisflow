...
const segmentClassName =
  "h-8 rounded-sm border border-transparent bg-transparent px-4 text-sm font-bold text-(--ink) transition duration-150 hover:bg-(--teal-soft) focus-visible:outline-none";
